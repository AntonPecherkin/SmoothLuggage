...
import com.silwester.smoothluggagecustomer.BuildConfig;
import com.silwester.smoothluggagecustomer.R;
import com.silwester.smoothluggagecustomer.ar.arcore.renderer.RectanglePolygonRenderer;
import com.silwester.smoothluggagecustomer.ar.helloar.CameraPermissionHelper;
import com.silwester.smoothluggagecustomer.ar.helloar.DisplayRotationHelper;
import com.silwester.smoothluggagecustomer.ar.helloar.rendering.BackgroundRenderer;
import com.silwester.smoothluggagecustomer.ar.helloar.rendering.ObjectRenderer;
import com.silwester.smoothluggagecustomer.ar.helloar.rendering.PlaneRenderer;
import com.silwester.smoothluggagecustomer.ar.helloar.rendering.PointCloudRenderer;
...
public class MeasureLuggageFragment extends Fragment {
    ...
    private static final String TAG = MeasureLuggageFragment.class.getSimpleName();
...
//            log(TAG, "onScroll, dx=" + distanceX + " dy=" + distanceY);
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < cubeIconIdArray.length; i++) {
            ivCubeIconList[i] = view.findViewById(cubeIconIdArray[i]);
...
//        });
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] results) {
        ...
        Toast.makeText(getActivity(), "Need to provide permission", Toast.LENGTH_LONG)
                .show();
    ...
    private void setupRenderer() {
        ...
        // Set up tap listener.
        gestureDetector = new GestureDetector(getActivity(), gestureDetectorListener);
        ...
        glSerfaceRenderer = new GLSurfaceRenderer(getActivity());
...
//            log(TAG, "onDrawFrame(), mTouches.size=" + mTouches.size());
            ...
            try {
                ...
                MeasureLuggageFragment.this.pointCloud.update(pointCloud);
                MeasureLuggageFragment.this.pointCloud.draw(viewmtx, projmtx);
